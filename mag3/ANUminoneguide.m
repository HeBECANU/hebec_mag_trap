...
Nah=1;%22.5
zah=.65/100;
Rah=.2/100;%(1.4/2)*(25.4/1000); Mean radius + a little for heatshrink
x1=.25/100
l=2*pi*Rah*Nah*2;
RR=21*l/1000;
...
for ttt=1:steps+1
 ...
 B(counter,2)=Ayy;
 B(counter,3)=Azz;
 B(counter,(4:6))= (I1*Nah*biasmag(k,Rah,zah,Axx,Ayy,Azz,intsteps))+(I2*Nah*helmx(k,Rah,x1,Axx,Ayy,Azz,intsteps));
