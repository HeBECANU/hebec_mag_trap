...
for ttt=1:steps+1
 ...
 B(counter,2)=Ayy;
 B(counter,3)=Azz;
 B(counter,(4:6))= (Iah*Nah*ahmag(k,Rah,zah,Axx,Ayy,Azz,intsteps))+(Iah2*Nah2*ahmag(k,Rah2,zah2,Axx,Ayy,Azz,intsteps))+[0,0,0];
...
hold on
xxx=[17.5 27.5 37.5 47.5 57.5 67.5 77.5 87.5 97.5 107.5]+55;
Bbb=[29.6 26 22.9 20.7 19 17.3 16.4 15.4 14.4 13.9]-11;
xxx=xxx;
Bbb=Bbb*100/7.7;
