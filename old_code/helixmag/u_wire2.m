...
R1=.75/100;%4.6228
I1=1.248*(1-0); %20 -> tight, 15 -> high bias for experiment
N1=10;%23.5
...
z2=2*zdd/1000;
R2=0.7/100;%4.6228
I2=-3.2*(1+0); %20 -> tight, 30 -> high bias for experiment
N2=18 ;%23.5
...
testpointx=(0.16)/100;%0.5/100 -> tight 0.23/100 -> high bias experiment
testpointy=0/100;
testpointz=0.00/100;
addedbias=0e-4;
