...
for ss=1:numz3s
   ...
   B(counter,(4:6))=B(counter,(4:6))+((I3/stepsr)*ahmagoffhelix(k,x3,R3temp,pi,2*pi,2*z3temp,thick3z,Axx,Ayy,Azz,intsteps));
   B(counter,(4:6))=B(counter,(4:6))+((I3/stepsr)*ahmagoffhelix(k,x3,R3temp,0,pi,(2*z3temp)+((pi)/pi*thick3z),thick3z,Axx,Ayy,Azz,intsteps));
