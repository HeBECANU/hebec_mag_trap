...
function[Btotal]=helixturnoffxy(k,offsetx,offsety,Rx,Ry,Rz,zstart,wirethickness,dtheta,theta,Axx,Ayy,Azz) 
...
Btotal=magarcmathelixoffxy(k,offsetx,offsety,Rx,Ry,Rz,zstart,Axx,Ayy,Azz,dtheta,theta,b,omega);
