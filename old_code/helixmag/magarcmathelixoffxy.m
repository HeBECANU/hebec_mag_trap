...
function[B]=magarcmathelixoffxy(k,offsetx,offsety,Rx,Ry,Rz,zstart,Ax,Ay,Az,dtheta,theta,b,omega) 

% ok let the origin be in the center of the trapping region

% the relevant distances are then:

rx=Rx-Ax+offsetx; %We are off axis in the x-axis
ry=Ry-Ay+offsety;% We are off axis in the y-axis
rz=Rz-Az;
