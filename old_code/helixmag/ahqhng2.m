...
z3=2*zdd/1000;
xs=1.4/100;ys=-1.6/100;xf=xs;yf=-1*ys;zoff=3/100;
xthick=10e-3;
N3=18;
I3=-40;
...
for ss=1:numz3s
   ...
   B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xs,xf,yftemp,ystemp,z3temp,z3temp,Axx,Ayy,Azz,intsteps)); %bit that does correct field
    B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf,xf+xthick,ystemp,ystemp,z3temp,z3temp,Axx,Ayy,Azz,intsteps)); %bit that does correct field
   B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf+xthick,xf+xthick,ystemp,ystemp,z3temp,z3temp+zotemp,Axx,Ayy,Azz,intsteps)); % bit that heads out
    B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf+xthick,xf,ystemp,ystemp,z3temp+zotemp,z3temp+zotemp,Axx,Ayy,Azz,intsteps)); % bit that heads out
  B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf,xf,ystemp,yftemp,z3temp+zotemp,z3temp+zotemp,Axx,Ayy,Azz,intsteps)); % bit does incorrect field
  B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf,xf+xthick,yftemp,yftemp,z3temp+zotemp,z3temp+zotemp,Axx,Ayy,Azz,intsteps)); % bit does incorrect field
   B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf+xthick,xf+xthick,yftemp,yftemp,z3temp+zotemp,z3temp,Axx,Ayy,Azz,intsteps)); % bit that heads out
   B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf+xthick,xf,yftemp,yftemp,z3temp,z3temp,Axx,Ayy,Azz,intsteps)); % bit that heads out
   ...
   %%coils on one '-z' side%
    ...
    B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf,xf+xthick,yftemp,yftemp,-z3temp,-z3temp,Axx,Ayy,Azz,intsteps)); %bit that does correct field
   B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf+xthick,xf+xthick,yftemp,yftemp,-z3temp,-(z3temp+zotemp),Axx,Ayy,Azz,intsteps)); % bit that heads out
    B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf+xthick,xf,yftemp,yftemp,-(z3temp+zotemp),-(z3temp+zotemp),Axx,Ayy,Azz,intsteps)); % bit that heads out
  B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf,xf,yftemp,ystemp,-(z3temp+zotemp),-(z3temp+zotemp),Axx,Ayy,Azz,intsteps)); % bit does incorrect field
  B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf,xf+xthick,ystemp,ystemp,-(z3temp+zotemp),-(z3temp+zotemp),Axx,Ayy,Azz,intsteps)); % bit does incorrect field
   B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf+xthick,xf+xthick,ystemp,ystemp,-(z3temp+zotemp),-z3temp,Axx,Ayy,Azz,intsteps)); % bit that heads out
   B(counter,(4:6))=B(counter,(4:6))+(I3*linemag(k,xf+xthick,xf,ystemp,ystemp,-z3temp,-z3temp,Axx,Ayy,Azz,intsteps)); % bit that heads out
