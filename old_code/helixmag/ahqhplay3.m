...
zdd=5.5+2.7+0.8+.25+.2;%5+2.6+0.75+0.25+.2;
...
N2=14;%23.5
x2=2.0/100; % use 1.95 for higher trap!
...
for ss=1:numz2s
    ...
    z2temp=z2/2+(thick2z/2)+(thick2z*(ss-1))+(rgap*(ss-1));   
    
    for tt =1:numr2s
    R2temp=R2+(thick2z/2)+(thick2z*(tt-1));  
