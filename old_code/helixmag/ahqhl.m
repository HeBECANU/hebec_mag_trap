...
%same as ahqh, except we add a coil in the other plane for loading
...
R1=.75/100;%4.6228
I1=5*(1-0); %20 -> tight, 15 -> high bias for experiment
N1=10;%23.5
...
testpointx=0.25/100;%0.5/100 -> tight 0.23/100 -> high bias experiment
testpointy=-0.0/100;
addedbias=0e-4;
...
B(counter,(4:6))=B(counter,(4:6))+(I3*N3*Qmag(k,R3,xoff,Axx,Ayy,Azz,intsteps));
end
if axiss(ll)==1
