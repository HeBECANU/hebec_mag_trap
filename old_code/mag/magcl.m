...
[startx1,starty1,startz1,stopx1,stopy1,stopz1,startx2,starty2,startz2,stopx2,stopy2,...
 stopz2,Rxi,Ryi,Rzi,Rxo,Ryo,Rzo,theta1,theta2]=makevector(x1start,x1stop,y1start,...
y1stop,z1start,z1stop,x2start,x2stop,y2start,y2stop,z2start,z2stop,Rin,Rout,...
thetaoutstart,thetaoutstop,thetainstart,thetainstop,intsteps); 

   Bmat=clmagmat(k,startx1,starty1,startz1,stopx1,stopy1,...
   stopz1,startx2,starty2,startz2,stopx2,stopy2,stopz2,Rxi,Ryi,...
   Rzi,Rxo,Ryo,Rzo,dtheta,theta1,theta2,Axx,Ayy,Azz);
