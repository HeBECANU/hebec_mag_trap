...
function[startx1,starty1,startz1,stopx1,stopy1,...
   ...
   Rzi,Rxo,Ryo,Rzo,dtheta1,dtheta2,theta1,theta2]=makevector(x1start,x1stop,y1start,...
y1stop,z1start,z1stop,x2start,x2stop,y2start,y2stop,z2start,z2stop,Rin,...
Rout,thetaoutstart,thetaoutstop,thetainstart,thetainstop...
,intsteps) 
