...
Iah=1; %-60
Nah=50;%22.5
zah=0/1000;%*(31+(Nah*1.6))/1000;
Rah=1.7/100%(1.4/2)*(25.4/1000); Mean radius + a little for heatshrink
l=2*pi*Rah*Nah*2;
RR=21*l/1000;
VV=Iah*RR
%%%% Note 1T = 10^4 G %%%%%%
...
for ttt=1:steps+1
 ...
 B(counter,2)=Ayy;
 B(counter,3)=Azz-tp;
 B(counter,(4:6))= (Iah*Nah*onecoilmag(k,Rah,zah,Axx,Ayy,Azz,intsteps));
