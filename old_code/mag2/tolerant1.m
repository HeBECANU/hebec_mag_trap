...
dz = +.041; % experimentally determined effective shift (+.041)
addedbias=3e-4;%-15e-4;
gasketthickness=.05;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Clover details%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Ibias=125;% shunted bias Vb =1.116 ~ 0.178 Amps
...
Icurv=0;%50; %157.1, 132.7 freq@132.7 = 106 Hz, 127.6
...
for ss=1:numlayerscloverz
 ...
 for tt =1:numlayerscloverr
   ...
   B(counter,(4:6))=B(counter,(4:6))+(Iclover*clovermagcompextra(k,Rin,Rout,offset,zclover,Axx,Ayy,Azz,intsteps,0,2)); % this adds the extra outer arc
...
B(counter,(4:6))=B(counter,(4:6))+(Iclover*clovermagcompextra(k,Rin,Rout,offset,zclover,Axx,Ayy,Azz,intsteps,0,2)); % this adds the extra outer arc, note the subtraction of one outer coil is 
	B(counter,(4:6))=B(counter,(4:6))+[addedbias 0 0];																																		% taken care of in clmagmat!!!!!
