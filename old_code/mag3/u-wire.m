...
B(counter,(4:6))=B(counter,(4:6))+(I1*linemag(k,xstart,xstop,ystart,ystart,zstart,zstart,Axx,Ayy,Azz,intsteps)); 
B(counter,(4:6))=B(counter,(4:6))+(I1*linemag(k,xstart,xstart,ystart,ystart,zstop,zstart,Axx,Ayy,Azz,intsteps)); 
B(counter,(4:6))=B(counter,(4:6))+(I1*linemag(k,xstop,xstop,ystart,ystart,zstart,zstop,Axx,Ayy,Azz,intsteps))+bias; 
