...
function[Btotal]=helixturn(k,Rx,Ry,Rz,zstart,wirethickness,dtheta,theta,Axx,Ayy,Azz) 
...
Btotal=magarcmathelix(k,Rx,Ry,Rz,zstart,Axx,Ayy,Azz,dtheta,theta,b,omega);
